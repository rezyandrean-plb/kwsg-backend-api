...
async function simpleDataFix() {
  ...
  console.log('🔧 Simple Data Quality Fix');
  console.log('==========================');
  
  try {
    // Step 1: Fix projects with missing price_from using unit_pricing data
    ...
    for (const project of projectsToFix) {
      // Find the minimum price from unit_pricing for this project
    ...
    for (const pricing of pricingToFix) {
      ...
      if (pricing.price_to && pricing.price_to > 0) {
        ...
        // Strategy 2: Get average price for this project and unit type
    ...
    // Step 4: Fix projects with missing location
    console.log('\n📊 Step 4: Fixing projects with missing location...');
