...
export interface ApiDevelopersDeveloper extends Struct.CollectionTypeSchema {
  ...
  options: {
    comment: 'Property developers and companies';
    draftAndPublish: false;
  };
  attributes: {
...
export interface ApiFacilitiesFacility extends Struct.CollectionTypeSchema {
  ...
  options: {
    comment: 'Facilities and amenities available in property projects';
    draftAndPublish: false;
  };
  attributes: {
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiFloorPlansFloorPlan extends Struct.CollectionTypeSchema {
  ...
  options: {
    comment: 'Floor plans for property units';
    draftAndPublish: false;
  };
  attributes: {
...
export interface ApiProjectImagesProjectImage
  ...
  options: {
    comment: 'Images associated with property projects';
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project-images.project-image'
    > &
      Schema.Attribute.Private;
...
export interface ApiProjectsProject extends Struct.CollectionTypeSchema {
  ...
  options: {
    comment: 'Main projects table containing all property development information';
    draftAndPublish: false;
  };
  attributes: {
